                            ...
                            <table class="table colored-table inverse-tabl table-striped" id="dynamic_field">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-success fa fa-plus" rel="tooltip" title="Add row" id='add_field' aria-hidden="true"></button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table> 
        ...
        $(document).ready(function(){
            ...
            {  
               ...
               $('#dynamic_field').append('<tr id="row'+x+'" class="dynamic-added">'+
                ...
                '<td><button type="button" rel="tooltip" title="Delete row" name="remove" id="'+x+'" class="btn btn-danger btn_remove">X</button></td>'+
                    '</tr>');  
            });
