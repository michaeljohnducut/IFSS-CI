                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-3">
                                                    <button type="submit" class="btn btn-success waves-effect text-left">Add Type</button>
                                                </div> 
                                            </div>
                                            </form>
                                        </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-3">
                                                    <button type="submit" class="btn btn-success waves-effect text-left">Update Type</button>
                                                </div> 
                                            </div>
                                            </form>
                                        </div>
